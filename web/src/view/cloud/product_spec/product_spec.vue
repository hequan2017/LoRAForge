  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="系统盘容量(GB)" prop="systemDiskCapacityGb" width="120" />

            <el-table-column align="left" label="数据盘容量(GB)" prop="dataDiskCapacityGb" width="120" />
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="系统盘容量(GB)">
                        {{ detailForm.systemDiskCapacityGb }}
                    </el-descriptions-item>
                    <el-descriptions-item label="数据盘容量(GB)">
                        {{ detailForm.dataDiskCapacityGb }}
                    </el-descriptions-item>
