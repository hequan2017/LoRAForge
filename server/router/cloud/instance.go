...
func (s *InstanceRouter) InitInstanceRouter(Router *gin.RouterGroup, PublicRouter *gin.RouterGroup) {
	...
	instRouterWithoutAuth := PublicRouter.Group("inst")
	{
		...
		instRouter.POST("file/upload", instApi.UploadContainerFile)           // upload file
		instRouter.POST("file/delete", instApi.RemoveContainerFile)           // delete file
	}
	{
		...
		instRouterWithoutRecord.GET("stats", instApi.GetContainerStats)             // stats
		instRouterWithoutRecord.GET("file/list", instApi.ListContainerFiles)        // list files
		instRouterWithoutRecord.GET("file/download", instApi.DownloadContainerFile) // download file
	}
	{
