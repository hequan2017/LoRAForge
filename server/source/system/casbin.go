...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		// 微调任务 API 权限
		{Ptype: "p", V0: "888", V1: "/finetune/createFineTuneTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/startFineTuneTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/restartFineTuneTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/stopFineTuneTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/cancelFineTuneTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/deleteFineTuneTask", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/finetune/deleteFineTuneTaskByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/finetune/updateFineTuneTask", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/finetune/createFineTuneTaskSnapshot", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/exportFineTuneTaskModel", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/syncFineTuneTaskStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/syncAllFineTuneTaskStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/finetune/findFineTuneTask", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/finetune/getFineTuneTaskList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/finetune/getFineTuneTaskLogs", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/finetune/getFineTuneTaskMetrics", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/finetune/getFineTuneTaskSnapshots", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/finetune/getFineTuneTaskStatistics", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/finetune/getFineTuneTaskDataSource", V2: "GET"},

		// 实例管理相关 API 权限 (确保完整)
		{Ptype: "p", V0: "888", V1: "/inst/createInstance", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/inst/closeInstance", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/inst/restartInstance", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/inst/deleteInstance", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/inst/deleteInstanceByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/inst/updateInstance", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/inst/findInstance", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/getInstanceList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/getInstanceDataSource", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/stats", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/webssh", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/logs", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/file/list", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/file/download", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/inst/file/upload", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/inst/file/delete", V2: "POST"},

		// 镜像/网络/卷 API 权限
		{Ptype: "p", V0: "888", V1: "/cloud/image/list", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cloud/image/pull", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cloud/image/delete", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cloud/network/list", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cloud/network/create", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cloud/network/delete", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cloud/volume/list", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cloud/volume/create", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cloud/volume/delete", V2: "DELETE"},
